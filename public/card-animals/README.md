...
## Entrega optimizada para móviles

La interfaz usa `optimized/*-v1.webp` (600 px, transparencia conservada, 37–47 KB por archivo), derivados de los PNG originales. Los originales se conservan como fuente. Los nombres incluyen versión para permitir caché prolongada sin servir diseños antiguos. Incrementar la versión al sustituir una ilustración.
